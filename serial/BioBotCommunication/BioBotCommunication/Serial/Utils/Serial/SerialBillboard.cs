...
namespace BioBotCommunication.Serial.Utils.Serial
{
    public class SerialBillboard
    {
        ...
        public event EventHandler<SerialBillboardCompletionEventArgs> onBillboardCompletionEvent;

        public SerialBillboard()
        {
            ...
            lock (registerLock)
            {
                ...
                if (isRegistered)
                {
                    ...
                    if (listConsumers.Count == 0)
                    {
                        ...
                        {
                            onBillboardCompletionEvent(this, new SerialBillboardCompletionEventArgs());
